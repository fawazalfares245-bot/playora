...
- F-ORG2-13: Partially fixed — the cancel, series-cancel and remove-player dialogs now state that refunds go to the player's wallet; a gateway refund path still needs the server.
