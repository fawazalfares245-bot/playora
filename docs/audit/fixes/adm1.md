...
- F-ADM1-32: Partially fixed — admin actions now go to a separate 5,000-row store with full actor id and no placeholder IP (see F-XC-7); a tamper-evident server-side log still needs the backend.
