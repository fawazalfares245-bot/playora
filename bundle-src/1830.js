        ...
        return (0, N.jsxs)(c.SafeAreaView, {
          ...
          children: [
            ...
            (0, N.jsxs)(a.default, {
              ...
              children: [
                (0, N.jsxs)(i.default, {
                  style: [y.typography.caption, { color: m.textMuted, marginBottom: y.spacing.md }],
                  children: [
    ...
    const R = ({ d: e, colors: t, t: l }) => {
        ...
        return (0, N.jsxs)(n.default, {
          ...
          children: [
            ...
            (0, N.jsx)(V, {
              label: l("kpiRevenue"),
              value: (0, j.formatPrice)(r.revenueKwd),
              colors: t,
              accent: !0,
            }),
            (0, N.jsx)(V, {
              label: l("kpiCommission"),
              value: (0, j.formatPrice)(r.commissionKwd),
              colors: t,
              accent: !0,
            }),
            (0, N.jsx)(V, {
          ...
          children: [
            ...
            (0, N.jsxs)(n.default, {
              ...
              children: [
                (0, N.jsx)(V, {
                  label: l("finWeek"),
                  value: (0, j.formatPrice)(r.revenueWeekKwd),
                  colors: t,
                }),
                (0, N.jsx)(V, {
                  label: l("finMonth"),
                  value: (0, j.formatPrice)(r.revenueMonthKwd),
                  colors: t,
                }),
                (0, N.jsx)(V, {
                  label: l("finYear"),
                  value: (0, j.formatPrice)(r.revenueYearKwd),
                  colors: t,
                }),
                (0, N.jsx)(V, {
                  label: l("kpiCommission"),
                ...
                (0, N.jsx)(V, { label: l("finRefunds"), value: (0, j.formatPrice)(r.refundsKwd), colors: t }),
                (0, N.jsx)(V, {
                  label: l("finOutstanding"),
                  value: (0, j.formatPrice)(r.outstandingKwd),
                  colors: t,
                }),
                (0, N.jsx)(V, {
                  label: l("finAvgBooking"),
                  value: (0, j.formatPrice)(r.avgBookingValueKwd),
                  colors: t,
                }),
                (0, N.jsx)(V, { label: l("finArpu"), value: (0, j.formatPrice)(r.arpuKwd), colors: t }),
                (0, N.jsx)(V, { label: l("finLtv"), value: (0, j.formatPrice)(r.ltvKwd), colors: t }),
                (0, N.jsx)(V, {
                  label: l("finCac"),
                  value: (0, j.formatPrice)(r.cacKwd),
                  colors: t,
                  sub: l("biModeled"),
                }),
              ],
            ...
            (0, N.jsx)(E, {
              title: l("finBySport"),
              rows: r.revenueBySport.map((e) => [e.label, (0, j.formatPrice)(e.value)]),
              colors: t,
            }),
            (0, N.jsx)(E, {
              title: l("finByVenue"),
              rows: r.revenueByVenue.map((e) => [e.label, (0, j.formatPrice)(e.value)]),
              colors: t,
            }),
            (0, N.jsx)(E, {
              title: l("finByOrganizer"),
              rows: r.revenueByOrganizer.map((e) => [e.label, (0, j.formatPrice)(e.value)]),
              colors: t,
            }),
          ],
        });
      ...
      T = ({ d: e, colors: t, t: l }) => {
        ...
        return (0, N.jsxs)(N.Fragment, {
          children: [
            ...
            (0, N.jsx)(E, {
              title: l("finByVenue"),
              rows: r.revenuePerVenue.map((e) => [e.label, (0, j.formatPrice)(e.value)]),
              colors: t,
            }),
          ],
        });
                ...
                n.default,
                {
                  ...
                  children: [
                    ...
                    (0, N.jsx)(i.default, {
                      ...
                      children: (0, j.formatPrice)(e.revenueKwd),
                    }),
                  ],
                },
                e.id,
        ...
        return (0, N.jsx)(N.Fragment, {
          children: (0, N.jsxs)(n.default, {
            ...
            children: [
              ...
              (0, N.jsx)(V, { label: l("hLogins"), value: (0, j.formatNumber)(r.loginActivity), colors: t }),
              (0, N.jsx)(V, {
